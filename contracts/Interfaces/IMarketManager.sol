...
interface IMarketManager {
    ...
    function getMarketsForRiskManager(address _riskManager) external view returns (address[] memory);

    function getMarketKeysForRiskManager(address _riskManager) external view returns (bytes32[] memory);

    function getMarketAddress(bytes32 marketKey) external view returns (address);

    function getMarketBaseToken(bytes32 marketKey) external view returns (address);

    function getMarketMarginToken(bytes32 marketKey) external view returns (address);
