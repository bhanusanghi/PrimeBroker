...
contract ACLRegistry is IACLRegistry {
    ...
    function isRoleAdmin(bytes32 role, address account) public view override {
        require(
            ...
            "you have to be role admin"
        );
    }

    function requireApprovedContractOrEOA(address account)
        public
        view
        override
    {
        require(
            hasRole(APPROVED_CONTRACT_ROLE, account) || account == tx.origin,
