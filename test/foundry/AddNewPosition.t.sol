...
contract AddNewPosition is BaseSetup {
        ...
        public
    {
        ...
        uint256 maxExpectedLiquidity = vault.maxExpectedLiquidity();
        vm.assume(
            liquiMargin > 1000 * ONE_USDC && liquiMargin < maxExpectedLiquidity
        );
        int256 currentPnL = 0;
        uint256 interestAccrued = 0;
        ...
        console2.log("totalBP", buyingPower.convertTokenDecimals(6, 18));
        ...
        console2.log("margin snx1", marginSNX1);
        console2.log("margin snx2", marginSNX2);
