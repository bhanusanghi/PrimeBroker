...
//         vm.startPrank(admin);
//         IERC20(usdc).approve(address(contracts.vault), largeAmount);
//         contracts.vault.deposit(largeAmount, admin);
//         vm.stopPrank();
...
//         // console2.log("expectedLiquidity", contracts.vault.expectedLiquidity(), largeAmount);
